...
class SentEmbeddings():
    ...
    def __init__(self,
                 word_embeddor,
                 weightfile_pretrain=r'..\SIFRank\SIFRank\auxiliary_data\enwiki_vocab_min200.txt',
                 weightfile_finetune=r'..\SIFRank\SIFRank\auxiliary_data\inspec_vocab.txt',
        ...
        if(database=="Inspec"):
            ...
            weightfile_finetune = r'C:\Users\Nick\source\repos\SIFRank\SIFRank\auxiliary_data\enwiki_vocab_min200.txt'
